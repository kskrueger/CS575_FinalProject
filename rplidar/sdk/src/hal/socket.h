...
namespace rp {
    namespace net {
        ...
        class _single_thread StreamSocket
        ...
        virtual StreamSocket *accept(SocketAddress * pairAddress = NULL)
        = 0;
        ...
        virtual u_result getPeerAddress(SocketAddress & )
        = 0;
        ...
        StreamSocket() {} // use dispose();
        StreamSocket() {}
    };

    class _single_thread DGramSocket
